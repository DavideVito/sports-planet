        ...
        <div className={classes.root}>
            ...
            <TabPanel value={value} index={1}>
                <div className="container">
                    <div className="row">
                        <strong><h2 className={"page-title-h2"}>Cerca tra Giocatori, allenatori, squadre e molto
                            altro</h2></strong>
                        <strong><p style={{color: "orange"}}>I risultati compariranno nella tabella sotto la barra di
                            ricerca </p></strong>
                    ...
                    <br/>
                    <p>Clicca l'icona <StarIcon></StarIcon> per aggiungere un utente ai
                        preferiti</p>
                    <br/>
                    <div style={{overflow:"auto",fontWeight:"bold"}}
                    >
