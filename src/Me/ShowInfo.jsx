...
const ShowInfo = ({ id }) => {
  ...
  return (
    <div>
      ...
      {utente.sport === "Calcio" ? (
        <GiocatoreCalcio data={utente} />
      ) : utente.sport === "Pallavolo" ? (
        <GiocatorePallavolo data={utente} />
      ) : (
        <>
          nessun dato trovato...Compila la tua{" "}
          <a href="/aggiungiInfo">scheda informativa</a>{" "}
        </>
      )}
      <div></div>
